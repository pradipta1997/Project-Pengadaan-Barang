...
<head>
    ...
    <title><?= $title; ?> | Aplikasi Pendataan Pengadaan Barang</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-white sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex text-white align-items-center bg-primary justify-content-center" href="">
                ...
                <div class="sidebar-brand-text mx-3">Pendataan Pengadaan Barang</div>
            </a>
            ...
            <footer class="sticky-footer bg-light">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Aplikasi Pendataan Pengadaan Barang 2021 &bull; by <?= anchor('https://www.facebook.com/pradiptaramadhan1997', 'Pradipta Ramadhan'); ?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
